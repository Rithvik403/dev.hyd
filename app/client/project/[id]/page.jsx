...
export default function ClientProjectPage({ onLogout }) {
  ...
  if (error || !data) {
    return (
      <div style={{ textAlign: 'center', padding: '4rem' }}>
        ...
        <Link href="/client" className="btn btn-primary">Back to Dashboard</Link>
      </div>
    )
  }
    ...
    <>
      ...
      <div className="client-layout">
        ...
        <div className="client-header" style={{ marginBottom: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
          ...
          <Link href="/client" style={{ textDecoration: 'none', color: 'var(--accent)', fontSize: '0.9rem', fontWeight: 600 }}>
            ← Back to Dashboard
          </Link>
        </div>
      ...
      <footer>
        <div>
          © 2026 dev.hyd — <Link href="/" style={{ color: 'var(--muted)' }}>Back to site</Link>
        </div>
      </footer>
    </>
  )
