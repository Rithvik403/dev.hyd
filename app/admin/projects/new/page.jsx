    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <Link href="/admin/projects/new" className="active">🚀 New Project</Link>
          <Link href="/admin/blog/new">✍️ New Post</Link>
      ...
      <main className="admin-main">
        ...
        <form onSubmit={handleSubmit} className="premium-form-container">
          ...
          <div className="form-actions-bar">
            ...
            <Link href="/admin" className="btn btn-outline btn-lg">Cancel</Link>
          </div>
        </form>
      </main>
    </div>
