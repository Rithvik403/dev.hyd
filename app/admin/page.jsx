...
export default function AdminDashboardPage({ onLogout, onAdminEmulateClient }) {
            ...
            <div className="dashboard-grid-3col">
              ...
              <div className="v2-card">
                ...
                <div className="quick-actions-grid-v2">
                  ...
                  <Link href="/admin/projects/new" className="quick-action-btn-v2">
                  ...
                  <Link href="/admin/clients/new" className="quick-action-btn-v2">
                  ...
                  <Link href="/admin/blog/new" className="quick-action-btn-v2">
                    <div className="service-icon-v2" style={{ background: '#fff7ed', color: '#ea580c', border: 'none' }}>
        ...
        {activeTab === 'clients' && (
          <div className="v2-card">
            <div className="v2-card-header">
              ...
              <Link href="/admin/clients/new" className="btn btn-primary" style={{ padding: '0.45rem 1rem', fontSize: '0.82rem', borderRadius: '8px' }}>+ New Client</Link>
            </div>
            {clients.length === 0 ? (
        ...
        {activeTab === 'projects' && (
          <div className="v2-card">
            <div className="v2-card-header">
              ...
              <Link href="/admin/projects/new" className="btn btn-primary" style={{ padding: '0.45rem 1rem', fontSize: '0.82rem', borderRadius: '8px' }}>+ New Project</Link>
            </div>
            {projects.length === 0 ? (
        ...
        {activeTab === 'blogs' && (
          <div className="v2-card">
            <div className="v2-card-header">
              ...
              <Link href="/admin/blog/new" className="btn btn-primary" style={{ padding: '0.45rem 1rem', fontSize: '0.82rem', borderRadius: '8px' }}>+ New Post</Link>
            </div>
            {posts.length === 0 ? (
                    ...
                    {posts.map(p => {
                      ...
                      return (
                        <tr key={pId}>
                          ...
                          <td>
                            <Link href={`/blog/${p.slug}`} target="_blank" className="btn btn-sm btn-outline" style={{ padding: '0.25rem 0.6rem', fontSize: '0.78rem', borderRadius: '6px' }}>View</Link>
