  ...
  return (
    <div className="auth-page">
      <div className="auth-box">
        <Link href="/" className="logo" style={{ display: 'block', marginBottom: '1.5rem' }}>
          dev<span>.</span>hyd
        </Link>
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={<div className="auth-page"><div className="auth-card-wrapper"><div className="auth-header"><h2>Loading...</h2></div></div></div>}>
      <ResetPasswordForm />
    </Suspense>
  )
}
