    ...
    <>
      <nav className={navOpen ? 'nav-open' : ''}>
        ...
        <div className="nav-links">
          ...
          {role === 'admin' ? (
            <Link href="/admin" className="nav-accent-link" onClick={() => setNavOpen(false)}>Admin Dashboard</Link>
          ) : role === 'client' ? (
            <Link href="/client" className="nav-accent-link" onClick={() => setNavOpen(false)}>My Project</Link>
          ) : null}
        </div>
      </nav>
